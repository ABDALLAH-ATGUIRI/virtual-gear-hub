...
const Home = () => {
    const [fetch, { isProductLoading }] = useFetchAllProductsMutation();
    ...
    return (
        <div className="h-screen flex flex-col justify-start items-center gap-8">
            <div className='fixed p-6 w-full mt-16'>
                <SearchBar categories={[]} />
            </div>
            <div className="grid grid-cols-5 justify-center items-center gap-8 mt-36 p-8">
                {products?.length ?
