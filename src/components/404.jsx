                    ...
                    <div className="-mx-4 flex">
                        <div className="w-full px-4">
                            <div className="mx-auto max-w-md text-center">
                                ...
                                <Link to='/dasboard' className="inline-block rounded-lg border border-white px-8 py-3 text-center text-base font-semibold text-white transition hover:bg-white hover:text-primary">
                                    Go To Home
                                </Link>
                            </div>
                        </div>
