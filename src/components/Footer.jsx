...
const Footer = () => {
    ...
    return (
        <footer className="relative w-full bg-gray-800/20 px-14 py-3 flex items-center justify-between">
            <Typography
                as="a"
                variant="h5"
                color="White"
            ...
            <div className="flex gap-4 text-blue-gray-100 items-center sm:justify-center">
