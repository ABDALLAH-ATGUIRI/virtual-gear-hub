...
import { HiMagnifyingGlass, HiMinus } from "react-icons/hi2";
import {
    Card,
    Typography,
    List,
				...
				>
					<ListItem className="p-0" selected={open === 1}>
						<AccordionHeader
							...
							className="border-b-2 p-2 dark:hover:bg-black/60"
						>
					...
					<AccordionBody className="py-1">
						<div className="flex flex-col px-2 py-6 items-center">
							<div className="w-full flex justify-between">
								<span className="w-16 p-1 text-center bg-black/40 rounded-full">
									10{" "}
							...
							<Slider
								size="sm"
								defaultValue={50}
								className="text-center mt-6 text-secondary"
							/>
						</div>
					</AccordionBody>
				</Accordion>
					...
					<AccordionBody className="py-1">
						<div className="w-full flex flex-wrap gap-2 [&_*]:text-gray-500">
							<Checkbox
								...
								label="New project"
								ripple={true}
								className="h-4 w-4 rounded-none border-gray-500 bg-gray-900/10 transition-all hover:scale-105 hover:before:opacity-0"
							/>
							<Checkbox
								id="ripple-off"
								label="Resale projects"
								ripple={false}
								className="h-4 w-4 rounded-none border-gray-500 bg-gray-900/10 transition-all hover:scale-105 hover:before:opacity-0"
							/>
						</div>
